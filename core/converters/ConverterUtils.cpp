 ...
 * @see Serializable
 */
class ConverterUtils : public Serializable, public RevisionHandler {
...
public:
   ...
   * @see DataSink
   */
  static class DataSource : public Serializable, public RevisionHandler {
  ...
  public: 
     ...
     */
    DataSource(string location) throws Exception {
      super();
  ...
  public: 
     ...
     */
    static bool isArff(string location) {
     ...
     */
    Instances getDataSet() throws Exception {
      Instances		result;
     ...
     * @throws Exception 	if resetting of loader fails
     */
    Instances getDataSet(int classIndex) throws Exception {
      Instances		result;
     ...
     */
    Instances getStructure() throws Exception {
      if (m_BatchBuffer == NULL)
     ...
     * @throws Exception	if something goes wrong
     */
    Instances getStructure(int classIndex) throws Exception {
      Instances		result;
     ...
     * @see		#nextElement(Instances)
     */
    bool hasMoreElements(Instances structure) {
      bool	result;
     ...
     */
    static Instances read(string location) throws Exception {
      DataSource	source;
      Instances		result;
     ...
     * @throws Exception	if loading fails
     */
    static Instances read(InputStream stream) throws Exception {
      DataSource	source;
      Instances		result;
     ...
     * @throws Exception	if loading fails
     */
    static Instances read(Loader loader) throws Exception {
      DataSource	source;
      Instances		result;
  ...
  public:
     ...
     */
    DataSink(string filename) throws Exception {
      m_Stream = NULL;
     ...
     */
    static void write(string filename, Instances data) throws Exception {
      DataSink	sink;
     ...
     * @throws Exception	if writing fails
     */
    static void write(Saver saver, Instances data) throws Exception {
      DataSink	sink;
     ...
     * @throws Exception	if writing fails
     */
    static void write(OutputStream stream, Instances data) throws Exception {
      DataSink	sink;
...
protected:
  ...
  const static string CORE_FILE_LOADERS = 
   ...
   * (comma-separated list). */
  const static string CORE_FILE_SAVERS =
  ...
  static Hashtable<String,String> m_FileLoaders;
  
  /** all available URL loaders (extension &lt;-&gt; classname). */
  static Hashtable<String,String> m_URLFileLoaders;

  /** all available savers (extension &lt;-&gt; classname). */
  static Hashtable<String,String> m_FileSavers;
   ...
   */
  static Hashtable<String,String> getFileConverters(string classnames, String[] intf) {
    Vector	list;
    String[]	names;
    int		i;
   ...
   * @return		hashtable with ExtensionFileFilters
   */
  static Hashtable<String,String> getFileConverters(Vector classnames, String[] intf) {
   ...
   * @throws IOException 	if reading the next token fails
   */
  static void getToken(StreamTokenizer tokenizer) throws IOException {
   ...
   */
  static Vector<String> getConverters(Hashtable<String,String> ht) {
   ...
   */
  static Object getConverterForFile(string filename, Hashtable<String,String> ht) {
    Object	result;
    String	extension;
    int		index;
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static Object getConverterForExtension(string extension, Hashtable<String,String> ht) {
    Object	result;
    String	classname;
...
public:   
   ...
   */
  static bool isCoreFileLoader(string classname) {
    bool	result;
    String[]	classnames;
   ...
   * @return		the classnames of the loaders
   */
  static Vector<String> getFileLoaders() {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileLoader getLoaderForFile(string filename) {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileLoader getLoaderForFile(File file) {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileLoader getLoaderForExtension(string extension) {
   ...
   * @return		the classnames of the loaders
   */
  static Vector<String> getURLFileLoaders() {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileLoader getURLLoaderForFile(string filename) {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileLoader getURLLoaderForFile(File file) {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileLoader getURLLoaderForExtension(string extension) {
   ...
   */
  static bool isCoreFileSaver(string classname) {
    bool	result;
    String[]	classnames;
   ...
   */
  static Vector<String> getFileSavers() {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileSaver getSaverForFile(string filename) {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileSaver getSaverForFile(File file) {
   ...
   * @return		the converter if one was found, NULL otherwise
   */
  static AbstractFileSaver getSaverForExtension(string extension) {
