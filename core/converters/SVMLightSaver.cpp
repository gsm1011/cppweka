 ...
 * @see Saver
 */
class SVMLightSaver : public AbstractFileSaver, public BatchConverter,
...
public: 
  /** the file extension. */
  static string FILE_EXTENSION = SVMLightLoader.FILE_EXTENSION;

  /** the number of digits after the decimal point. */
  static int MAX_DIGITS = 18;
...
public: 
   ...
   */
protected:
  string instanceToSvmlight(Instance inst) {
    StringBuffer	result;
    int			i;
