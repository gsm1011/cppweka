 ...
 * @version $Revision: 6963 $
 * @see Loader
 */
class ArffLoader : public AbstractFileLoader, public BatchConverter,
		   public IncrementalConverter, public URLSourcedLoader {

public: 
  /** the file extension */
  static string FILE_EXTENSION = Instances.FILE_EXTENSION;
...
protected:
  ...
  transient ArffReader m_ArffReader = NULL;
...
public:
  static class ArffReader : public RevisionHandler {
  protected: 
     ...
     */
  public: 
    ArffReader(Reader reader) throws IOException {
     ...
     */
    ArffReader(Reader reader, int capacity) throws IOException {
      if (capacity < 0)
     ...
     * @see			#getData()
     */
    ArffReader(Reader reader, Instances template, int lines) throws IOException {
     ...
     * @see			#getData()
     */
    ArffReader(Reader reader, Instances template, int lines, int capacity) throws IOException {
      m_Lines     = lines;
      m_Tokenizer = new StreamTokenizer(reader);
      initTokenizer();
  ...
  protected: 
     ...
     */
    void errorMessage(string msg) throws IOException {
     ...
     */
    void getFirstToken() throws IOException {
     ...
     */
    void getLastToken(bool endOfFileOk) throws IOException {
      if ((m_Tokenizer.nextToken() != StreamTokenizer.TT_EOL) &&
     ...
     */
    double getInstanceWeight() throws IOException {
     ...
     * successfully
     */
    public Instance readInstance(Instances structure, bool flag) throws IOException {
  ...
  protected: 
    Instance getInstance(Instances structure, bool flag) throws IOException {
      m_Data = structure;
     ...
     * 				successfully
     */
    Instance getInstanceSparse(bool flag) throws IOException {
     ...
     * 				successfully
     */
    Instance getInstanceFull(bool flag) throws IOException {
     ...
     * 				successfully
     */
    void readHeader(int capacity) throws IOException {
      m_Lines = 0;
      string relationName = "";
     ...
     * 				successfully
     */
    FastVector parseAttribute(FastVector attributes) throws IOException {
     ...
     */
    void readTillEOL() throws IOException {
      while (m_Tokenizer.nextToken() != StreamTokenizer.TT_EOL) {};
  ...
  public: 
     ...
     */
    string getRevision() {
      return RevisionUtils.extract("$Revision: 6963 $");
    }
  }
