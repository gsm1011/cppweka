 ...
 * @see Saver
 */
class LibSVMSaver : public AbstractFileSaver, public BatchConverter,
...
public: 
  ...
  /** the file extension */
  static string FILE_EXTENSION = LibSVMLoader.FILE_EXTENSION;

protected: 
  /** the class index */
  SingleIndex m_ClassIndex = new SingleIndex("last"); 
...
public: 
   ...
   */
protected: 
  string instanceToLibsvm(Instance inst) {
    StringBuffer	result;
    int			i;
...
void main(int argc, char* argv[]) {
  runFileSaver(new LibSVMSaver(), argv[0]);
}
