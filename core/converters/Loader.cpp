 ...
 */
class Loader : public Serializable, public RevisionHandler {
 public: 
  /**
   ...
   * </jml></pre>
   */
  virtual void setSource(File file) throw(IOException) = 0;
   ...
   * support loading from a File.
   */
  virtual void setSource(InputStream input) throw(IOException) = 0;
   ...
   * </jml></pre>
   */
  virtual Instances getStructure() throw(IOException) = 0;
   ...
   * </jml></pre>
   */
  virtual Instances getDataSet() throw(IOException) = 0;
   ...
   * or batch loading can be used, not both).
   */
  virtual Instance getNextInstance(Instances structure) throw(IOException) = 0;
};
