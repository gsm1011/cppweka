...
/**
   ...
   * @version $Revision: 4908 $
   * @see Saver
   */
class CSVSaver : public AbstractFileSaver, public BatchConverter,
		 public IncrementalConverter, public FileSourcedConverter {
...
public: string getRevision() {
    return RevisionUtils.extract("$Revision: 4908 $");
  }
};
...
void main(int argc, char* argv[]) {
  runFileSaver(new CSVSaver(), argv[0]);
}
