 ...
 * @see Loader
 */
class SerializedInstancesLoader : public AbstractFileLoader, 
...
public: 
  /** the file extension */
  static string FILE_EXTENSION = Instances.SERIALIZED_OBJ_FILE_EXTENSION;
  
protected: 
  /** Holds the structure (header) of the data set. */
  Instances m_Dataset = NULL;

  /** The current index position for incremental reading */
  int m_IncrementalIndex = 0;
