...
public:
   ...
   */
  virtual string getFileDescription() = 0;
   ...
   */
  virtual void setFile(File file) throws IOException = 0;
   ...
   */
  virtual void setUseRelativePath(bool rp) = 0;
   ...
   */
  virtual bool getUseRelativePath() = 0;
