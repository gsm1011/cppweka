 ...
 */
class Tokenizer : public Enumeration,
...
public:
   ...
   */
  virtual void tokenize(string s);
   ...
   */
  static String[] tokenize(Tokenizer tokenizer, String[] options) throws Exception {
   ...
   * @param options	the options for the tokenizer
   */
  static void runTokenizer(Tokenizer tokenizer, String[] options) {
    String[]	result;
    int		i;
