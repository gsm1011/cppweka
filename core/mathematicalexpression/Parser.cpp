...
/** CUP v0.11a beta 20060608 generated parser.
  ...
  */
class Parser : public java_cup.runtime.lr_parser {
 public: 
  /** Default constructor. */
  Parser() {super();}

  /** Constructor which sets the default scanner. */
  Parser(java_cup.runtime.Scanner s) {super(s);}

  /** Constructor which sets the default scanner. */
  Parser(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {super(s,sf);}
  
  /** Access to production table. */
  short[][] production_table() {return _production_table;}

 protected: 
  /** Production table. */
  const static short _production_table[][] = 
  ...
  /** Parse-action table. */
  const static short[][] _action_table = 
    unpackFromStrings(new String[] {
 ...
 public: 
  ...
  short[][] action_table() {return _action_table;}

 protected: 
  /** <code>reduce_goto</code> table. */
  const static short[][] _reduce_table = 
    unpackFromStrings(new String[] {
 ...
 public: 
  ...
  java_cup.runtime.Symbol do_action(
    int                        act_num,
  ...
  int start_production() {return 1;}

  /** <code>EOF</code> Symbol index. */
  int EOF_sym() {return 0;}

  /** <code>error</code> Symbol index. */
  int error_sym() {return 1;}


 protected: 
  /** variable - value relation. */
  HashMap m_Symbols = new HashMap();
...
public: 
  ...
  const java_cup.runtime.Symbol CUP$Parser$do_action(
