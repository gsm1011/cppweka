 ...
 */
class MappingInfo : public Serializable {
   ...
   */
public:
  static final int UNKNOWN_NOMINAL_VALUE = -1;
...
private:
   ...
   */
  int[][] m_nominalValueMaps = null;
  
  /** Holds a textual description of the fields mapping */
  string m_fieldsMappingText = null;
  
  /** For logging */
  Logger m_log = null;
  
public:
  MappingInfo(Instances dataSet, MiningSchema miningSchema,
...
private:
  void fieldsMappingString(Instances miningSchemaI, Instances incomingI) {
...
public:
   ...
   */
  double[] instanceToSchema(Instance inst, 
