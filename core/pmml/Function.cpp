 ...
 */
class Function : public Serializable {
...
protected:
  ...
  ArrayList<Attribute> m_parameterDefs = null;
...
public:  
   ...
   * this function
   */
  virtual void setParameterDefs(ArrayList<Attribute> paramDefs) throws Exception;
   ...
   * @throws Exception if there is a problem computing the result of this function
   *
  double getResult(double[] incoming, Attribute outputDef) throws Exception {
   ...
   */
  static Function getFunction(string name, TransformationDictionary transDict)
    throws Exception {
