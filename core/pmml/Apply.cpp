...
protected:
  ...
  ArrayList<Expression> m_arguments = new ArrayList<Expression>();
  ...
  Attribute m_outputStructure = null;
   ...
   */
  Apply(Element apply, FieldMetaInfo.Optype opType, ArrayList<Attribute> fieldDefs,
...
private:
  void updateDefsForArgumentsAndFunction() throws Exception {
