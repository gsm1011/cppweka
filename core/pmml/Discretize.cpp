...
class Discretize : public Expression {
   ...
   */
 protected:
  class DiscretizeBin : public Serializable {
  ...
  protected:
    DiscretizeBin(Element bin) throws Exception {
...
private:
  void setUpField() throws Exception {
    m_fieldIndex = -1;
