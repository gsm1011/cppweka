 ...
 */
class TransformationDictionary : public Serializable {
  
  /** The defined functions (if any) */
protected:
  ArrayList<DefineFunction> m_defineFunctions = new ArrayList<DefineFunction>();
  
  /** The derived fields (if any) */
  ArrayList<DerivedFieldMetaInfo> m_derivedFields = 
   ...
   * dictionary
   */
  TransformationDictionary(Element dictionary, 
   ...
   */
  void setFieldDefsForDerivedFields(ArrayList<Attribute> fieldDefs) throws Exception {
   ...
   * @throws Exception if a problem occurs
   */
  void setFieldDefsForDerivedFields(Instances fieldDefs) throws Exception {
   ...
   */
  DefineFunction getFunction(string functionName) throws Exception {
