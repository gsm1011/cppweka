...
protected:
   ...
   */
public:
  static PMMLModel getPMMLModel(string filename) throws Exception {
   ...
   * @throws Exception if there is a problem while reading the file
   */
  static PMMLModel getPMMLModel(File file) throws Exception {
   ...
   */
  static PMMLModel getPMMLModel(InputStream stream) throws Exception {
   ...
   * @throws Exception if there is a problem while reading the file
   */
  static PMMLModel getPMMLModel(string filename, Logger log) throws Exception {
   ...
   * @throws Exception if there is a problem while reading the file
   */
  static PMMLModel getPMMLModel(File file, Logger log) throws Exception {
    return getPMMLModel(new BufferedInputStream(new FileInputStream(file)), log);
  }
  
private:
  static bool isPMML(Document doc) {
...
public:
   ...
   * @throws Exception if there is a problem while reading from the stream
   */
  static PMMLModel getPMMLModel(InputStream stream, Logger log) throws Exception {
   ...
   */
protected:
  static TransformationDictionary getTransformationDictionary(Document doc, 
...
protected:
   ...
   */
  static PMMLModel getModelInstance(Document doc, 
   ...
   */
  static ModelType getModelType(Document doc) {
   ...
   */
  static Element getModelElement(Document doc, ModelType modelType) 
    throws Exception {
    NodeList temp = null;
    Element model = null;
    switch (modelType) {
   ...
   */
  static Instances getMiningSchemaAsInstances(Element model,
                                                        Instances dataDictionary) 
    throws Exception {
  ...
  static Instances getDataDictionaryAsInstances(Document doc) 
    throws Exception {
  ...
  static string applyClassifier(PMMLModel model, Instances test) throws Exception {
...
private:
  static class PMMLClassifierRunner : public Classifier {
  public:
    double[] distributionForInstance(Instance test) throws Exception {
    ...
    void evaluatePMMLClassifier(String[] options) {
