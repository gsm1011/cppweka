...
class DefineFunction : public Function {
   ...
   */
protected:
  class ParameterField : public FieldMetaInfo {
    /**
     * For serialization
     */
   ...
   */
  ArrayList<ParameterField> m_parameters = new ArrayList<ParameterField>();
...
public:
  DefineFunction(Element container, TransformationDictionary transDict) throws Exception {
