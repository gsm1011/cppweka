...
class DerivedFieldMetaInfo : public FieldMetaInfo, 
			     public Serializable {
...
protected:
   ...
   * this derived field 
   */
  ArrayList<Value> m_values = new ArrayList<Value>();
  
  /** the single expression that defines the value of this field */
  Expression m_expression;
  
public:
  DerivedFieldMetaInfo(Element derivedField, ArrayList<Attribute> fieldDefs,
   ...
   */
  double getDerivedValue(double[] incoming) throws Exception {
