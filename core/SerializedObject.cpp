 ...
 */
class SerializedObject : public RevisionHandler {
...
public:
   ...
   */ 
  SerializedObject(Object toStore) throws Exception {
   ...
   * @exception Exception if the object couldn't be serialized
   */ 
  SerializedObject(Object toStore, bool compress) throws Exception {
