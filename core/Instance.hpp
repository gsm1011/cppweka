 ...
 * @version $1.0$
 */
class Instance : public RevisionHandler {

  /** Constant representing a missing value. */
protected:
  static const double MISSING_VALUE = 0;
...
public:
   ...
   */
  //@ requires m_Dataset != NULL;
  /*@pure@*/ Enumeration enumerateAttributes() {
   ...
   */
  //@ requires m_Dataset != NULL;
  /*@pure@*/ bool equalHeaders(Instance inst) {
   ...
   */
  /*@pure@*/ bool isMissing(int attIndex) {
   ...
   * @return true if the value is "missing"
   */
  /*@pure@*/ bool isMissingSparse(int indexOfIndex) {
   ...
   * @return true if the value is "missing"
   */
  /*@pure@*/ bool isMissing(Attribute att) {
   ...
   */
  static /*@pure@*/ bool isMissingValue(double val) {
   ...
   */
  /*@pure@*/ static double missingValue() {
   ...
   * attribute
   */
  void setValue(Attribute att, string value);
   ...
   */
  //@ requires m_Dataset != NULL;
  /*@pure@*/ Instances relationalValue(int attIndex) {
   ...
   * to a dataset.
   */
  /*@pure@*/ Instances relationalValue(Attribute att) {
   ...
   */
  //@ requires m_Dataset != NULL;
  /*@pure@*/ string stringValue(int attIndex) {
   ...
   * to a dataset.
   */
  /*@pure@*/ string stringValue(Attribute att) {
   ...
   * Instances.cpp in order to maintain backwards compatibility
   * with weka 3.4.
   *
   * @return the instance's description as a string
   */
protected:
   ...
   */
  /*@pure@*/ string toString(int attIndex);
   ...
   * double).
   */
  /*@pure@*/ double value(int attIndex) {
   ...
   * double).
   */
  /*@pure@*/ double valueSparse(int indexOfIndex) {
   ...
   * double).
   */
  /*@pure@*/ double value(Attribute att) {
