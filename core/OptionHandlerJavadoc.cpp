 ...
 * @see #OPTIONS_ENDTAG
 */
class OptionHandlerJavadoc : public Javadoc {
public:
  /** the start comment tag for inserting the generated Javadoc */
  const static string OPTIONS_STARTTAG = "<!-- options-start -->";
  
  /** the end comment tag for inserting the generated Javadoc */
  const static string OPTIONS_ENDTAG = "<!-- options-end -->";
...
protected:
  string generateJavadoc(int index) throws Exception {
	...
	throw Exception("Class '" + getClassname() + "' is not an OptionHandler!");
