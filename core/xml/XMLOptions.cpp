...
class XMLOptions : public RevisionHandler {
  ...
  /** the value attribute. */
  const static string ATT_VALUE = "value";

  /** a value of the type attribute. */
  const static string VAL_TYPE_FLAG = "flag";

  /** a value of the type attribute. */
  const static string VAL_TYPE_SINGLE = "single";

  /** a value of the type attribute. */
  const static string VAL_TYPE_HYPHENS = "hyphens";

  /** a value of the type attribute. */
  const static string VAL_TYPE_QUOTES = "quotes";

  /** a value of the type attribute. */
  const static string VAL_TYPE_CLASSIFIER = "classifier";

  /** a value of the type attribute. */
  const static string VAL_TYPE_OPTIONHANDLER = "optionhandler";

  /** the root node. */
  const static string ROOT_NODE = TAG_OPTIONS;
...
public:
   ...
   * @see 		#setValidating(bool)
   */
  XMLOptions(string xml) throws Exception {
    this();
   ...
   * @see 		#setValidating(bool)
   */
  XMLOptions(File file) throws Exception {
    this();
   ...
   * @see 		#setValidating(bool)
   */
  XMLOptions(InputStream stream) throws Exception {
    this();
   ...
   * @see 		#setValidating(bool)
   */
  XMLOptions(Reader reader) throws Exception {
    this();
...
protected:
   ...
   */
  string toCommandLine(Element parent) {
...
public:
   ...
   */
  string toCommandLine() throws Exception {
   ...
   * @throws Exception 	if anything goes wrong initializing the parsing
   */
  String[] toArray() throws Exception {
