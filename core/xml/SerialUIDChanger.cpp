 ...
 */
class SerialUIDChanger : public RevisionHandler {
    ...
    */
protected:
  static bool checkKOML() throws Exception {
      if (!KOML.isPresent())
    ...
    */
public:
  static bool isKOML(string filename) {
    ...
    */
   static Object readBinary(string binary) throws Exception {
      FileInputStream         fi;
    ...
    */
   static void writeBinary(string binary, Object o) throws Exception {
      FileOutputStream        fo;
    ...
    */
public:
  static void binaryToKOML(string binary, string koml) throws Exception {
      Object            o;
    ...
    */
   static void komlToBinary(string koml, string binary) throws Exception {
      Object         o;
    ...
    * @throws Exception if conversion fails
    */
   static void changeUID(long oldUID, long newUID, string fromFile, string toFile) throws Exception {
      string            inputFile;
      string            tempFile;
      File              file;
      string            content;
