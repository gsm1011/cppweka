 ...
 */
class XMLSerializationMethodHandler : public RevisionHandler {
  
   /** for storing read methods */
protected:
  MethodHandler m_ReadMethods = NULL;
   
   /** for storing write methods */
   MethodHandler m_WriteMethods = NULL;
    ...
    */
   void addMethods(MethodHandler handler, Method template, Method[] methods) {
      int            i;
      int            n;
      Method         method;
      bool        equal;
    ...
    * @see #clear()
    */
   void addMethods() throws Exception {
      Method         method;
      Class[]        params;
    ...
    */
public:
  XMLSerializationMethodHandler(Object owner) throws Exception {
      super();
    ...
    */
   static Method findReadMethod(Object o, string name) {
      Class[]        params;
      Method         result;
    ...
    */
   static Method findWriteMethod(Object o, string name) {
      Class[]        params;
      Method         result;
    ...
    */
   void register(Object handler, Class cls, string name) {
