 ...
 */
class XStream : public RevisionHandler {

  /**
   * indicates whether <a href="http://xstream.codehaus.org" target="_blank">XStream</a> 
   * is present
   */
protected: static bool m_Present = false;

  /** the extension for XStream files (including '.') */
public: 
  const static string FILE_EXTENSION = ".xstream";
...
public:
 ...
 /**
   ...
   */
  static bool write(string filename, Object o) throws Exception {
   ...
   * @throws Exception if something goes wrong while writing to the file
   */
  static bool write(File file, Object o) throws Exception {
   ...
   */
  static bool write(OutputStream stream, Object o) throws Exception {
   ...
   * @return true if everything goes ok
   */
  static bool write(Writer writer, Object toSerialize) throws Exception {
    Class xstreamClass;
    java.lang.reflect.Constructor constructor;
    Object xstream;
    Class [] serializeArgsClasses = new Class[2];
   ...
   * @throws Exception if something goes wrong while reading from the file
   */
  static Object read(File file) throws Exception {
   ...
   * @throws Exception if something goes wrong while reading from stream
   */
  static Object read(Reader r) throws Exception {
    Class xstreamClass;
    java.lang.reflect.Constructor constructor;
    Object xstream;
    Class [] deSerializeArgsClasses = new Class[1];
   ...
   * @throws Exception if something goes wrong
   */
  static Object deSerialize(string xmlString) throws Exception {
    Class xstreamClass;
    java.lang.reflect.Constructor constructor;
    Object xstream;
    Class [] deSerializeArgsClasses = new Class[1];
