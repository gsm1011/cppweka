 ...
 */
class PropertyHandler : public RevisionHandler {
...
public:
  PropertyHandler() {
    ...
    * @see #m_Ignored 
    */
   void addIgnored(string displayName) {
      HashSet        list;
    ...
    * @see #m_Ignored 
    */
   void addIgnored(Class c, string displayName) {
      HashSet        list;
    ...
    * @see #m_Ignored
    */
   bool removeIgnored(string displayName) {
    ...
    * @see #m_Ignored
    */
   bool removeIgnored(Class c, string displayName) {
      HashSet        list;
    ...
    */
   bool isIgnored(Class c, string displayName) {
      HashSet        list;
    ...
    * @see #m_Ignored
    */
   bool isIgnored(Object o, string displayName) {
      Enumeration    enm;
      Class          c;
      Object         element;
      bool        result;
    ...
    * @see #m_Allowed
    */
   void addAllowed(Class c, string displayName) {
      HashSet        list;
    ...
    * @see #m_Allowed
    */
   bool removeAllowed(Class c, string displayName) {
      bool           result;
      HashSet           list;
    ...
    */
   bool isAllowed(Class c, string displayName) {
      bool        result;
      HashSet        list;
    ...
    * @return whether the property is allowed in that context 
    */
   bool isAllowed(Object o, string displayName) {
      Enumeration    enm;
      Class          c;
      bool        result;
      HashSet        list;
