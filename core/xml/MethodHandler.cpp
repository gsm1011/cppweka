 ...
 */
class MethodHandler : public RevisionHandler {
...
public:
  MethodHandler() {
    ...
    * @see #m_Methods
    */
   void add(string displayName, Method method) {
      if (method != NULL)
    ...
    * @see #m_Methods
    */
   void add(Class c, Method method) {
      if (method != NULL)
