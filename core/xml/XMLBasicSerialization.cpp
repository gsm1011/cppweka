 ...
 */
class XMLBasicSerialization : public XMLSerialization {
public:
   /** the value for mapping, e.g., Maps */
   final static string VAL_MAPPING = "mapping";

   /** the value for a mapping-key, e.g., Maps */
   final static string VAL_KEY = "key";

   /** the value for mapping-value, e.g., Maps */
   final static string VAL_VALUE = "value";

   /** the matrix cells */
   final static string VAL_CELLS = "cells";
    ...
    */
   XMLBasicSerialization() throws Exception {
      super();
   }
    ...
    */
   Element writeDefaultListModel(Element parent, Object o, string name) 
      throws Exception {
    ...
    * @see javax.swing.DefaultListModel
    */
   Object readDefaultListModel(Element node) throws Exception {
      DefaultListModel     model;
      Vector               children;
      Element              child;
      int                  i;
    ...
    */
   Element writeCollection(Element parent, Object o, string name) 
      throws Exception {
    ...
    * @see java.util.Collection
    */
   Object readCollection(Element node) throws Exception {
      Collection           coll;
      Vector               v;
      Vector               children;
      Element              child;
    ...
    * @see java.util.Map
    */
   Element writeMap(Element parent, Object o, string name) 
      throws Exception {
    ...
    * @see java.util.Map
    */
   Object readMap(Element node) throws Exception {
      Map                  map;
      Object               key;
      Object               value;
      Vector               children;
    ...
    */
   Element writeMatrix(Element parent, Object o, string name) 
      throws Exception {
    ...
    * @see weka.core.matrix.Matrix
    */
   Object readMatrix(Element node) throws Exception {
      weka.core.matrix.Matrix    matrix;
      Vector                     children;
      Element                    child;
      int                        i;
    ...
    */
   Element writeMatrixOld(Element parent, Object o, string name) 
      throws Exception {
    ...
    * @see weka.core.Matrix
    */
   Object readMatrixOld(Element node) throws Exception {
      weka.core.Matrix           matrix;
    ...
    */
   Element writeCostMatrixOld(Element parent, Object o, string name) 
      throws Exception {
    ...
    * @see weka.classifiers.CostMatrix
    */
   Object readCostMatrixOld(Element node) throws Exception {
