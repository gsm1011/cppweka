 ...
 */
class FloatingPointFormat : public DecimalFormat, public RevisionHandler {
private:
  /** for serialization */
  const static final long serialVersionUID = 4500373755333429499L;
...
public:
  ...
  static string  pattern( int w, int d ) {
