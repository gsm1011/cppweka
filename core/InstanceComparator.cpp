 ...
 */
class InstanceComparator : public Comparator, 
...
public:
   ...
   */
  InstanceComparator(bool includeClass) {
    super();
   ...
   */
  void setIncludeClass(bool includeClass) {
