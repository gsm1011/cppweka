...
/*
 * TechnicalInformationHandlerJavadoc.cpp
 ...
 * @see #BIBTEX_ENDTAG
 */
class TechnicalInformationHandlerJavadoc : public Javadoc {
public:
  /** the start comment tag for inserting the generated BibTex */
  const static string PLAINTEXT_STARTTAG = "<!-- technical-plaintext-start -->";
  
  /** the end comment tag for inserting the generated BibTex */
  const static string PLAINTEXT_ENDTAG = "<!-- technical-plaintext-end -->";
  
  /** the start comment tag for inserting the generated BibTex */
  const static string BIBTEX_STARTTAG = "<!-- technical-bibtex-start -->";
  
  /** the end comment tag for inserting the generated BibTex */
  const static string BIBTEX_ENDTAG = "<!-- technical-bibtex-end -->";
...
protected:
  string generateJavadoc(int index) throws Exception {
	...
	throw Exception("Class '" + getClassname() + "' is not a TechnicalInformationHandler!");
