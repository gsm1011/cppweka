...
public:
   ...
   * @return true if the word is a stopword
   */
  static bool isStopword(string str) {
...
static void main(String[] args) throws Exception {
  ...
  bool print = Utils.getFlag('p', args);
