...
#ifndef ATTRIBUTEEXPRESSION_HPP_INCLUDED
#define ATTRIBUTEEXPRESSION_HPP_INCLUDED
...
#include "core/RevisionHandler.hpp"
 ...
 * @version $Revision: 1 $
 */
class AttributeExpression : public Serializable, public RevisionHandler {
     ...
     */
private:
    class AttributeOperand : public Serializable, public RevisionHandler {
     ...
     */
private:
    class NumericOperand : public Serializable,
...
public:
     ...
     */
    class Operator : public Serializable, public RevisionHandler {
...
#endif // ATTRIBUTEEXPRESSION_HPP_INCLUDED
