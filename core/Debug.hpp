 ...
 */
#ifndef _CPP_WEKA_DEBUG_H_
#define _CPP_WEKA_DEBUG_H_
...
protected:
  ...
  public:
     ...
     * @see               #m_OutputFormat
     */
    inline void setOutputFormat(int value) {
   ...
   */
    class Timestamp : public RevisionHandler {
  ...
  public:
     ...
     * @see		SimpleDateFormat
     */
    inline Timestamp(string format) {
   ...
   */
    class SimpleLog : public RevisionHandler {
  ...
  public:
     ...
     */
    inline SimpleLog(string filename) {
      this(filename, true);
    }
  ...
  public:
     ...
     */
    inline Log(string filename, int size, int numFiles) {
      m_Filename = filename;
      m_Size     = size;
      m_NumFiles = numFiles;
    }
  ...
  public:
     ...
     * @param message	the message to log
     */
    inline void log(Level level, string message) {
      log(level, "", message);
    }
     ...
     */
    inline void log(Level level, string sourceclass, string message) {
   ...
   */
public:
  class Random : public RevisionHandler {
  ...
  public:
     ...
     */
    inline void nextBytes(byte[] bytes) {
   ...
   * @version $Revision: 1.8 $
   */
    class DBO : public RevisionHandler {
  ...
  public:
     ...
     */
    inline void initializeRanges(int upper) {
     ...
     */
    inline bool outputTypeSet(int num) {
   ...
   /**
     ...
     */
    inline void setOutputTypes(string list) {
      if (list.length() > 0) {
        m_verboseOn = true; 
     ...
     * @param text the text to print
     */
    inline void dpln(int debugType, string text) {
   ...
   /**
     ...
     * @param text the text to print
     */
    inline void dp(int debugType, string text) {
     if (outputTypeSet(debugType)) {
        System.out.print(text);
      }
    } 
     ...
     * @param text the text to print
     */
    inline static void pln(string text) {
      System.out.println(text);
    } 
     ...
     * @param text the text to print
     */
    inline static void p (string text) {
      System.out.print(text);
    } 
...
public:
   ...
   * @param numFiles	the number of files for rotating
   */
  inline Debug(string filename, int size, int numFiles) {
    super();
   ...
   * @return		the corresponding level or the default
   */
  inline static Level stringToLevel(string level) {
   ...
   */
  inline static Log newLog(string filename, int size, int numFiles) {
   ...
   * @param message		the message to print
   */
  inline void log(Level level, string sourceclass, string sourcemethod, string message) {
    if (getEnabled())
   ...
   * @see		#getEnabled()
   */
  inline void stopClock(string message) {
    log(message + ": " + m_Clock);
  }
   ...
   */
  inline static java.util.Random newRandom() {
   ...
   * @return		a new instance of a Random object
   */
  inline static java.util.Random newRandom(int seed) {
   ...
   */
  inline static Timestamp newTimestamp() {
   ...
   */
  inline static string getTempDir() {
   ...
   */
  inline static string getHomeDir() {
   ...
   */
  inline static string getCurrentDir() {
   ...
   */
  inline static bool writeToFile(string filename, Object obj) {
   ...
   * @return		true if writing was successful
   */
  inline static bool writeToFile(string filename, string message) {
   ...
   * @return		true if writing was successful
   */
  inline static bool writeToFile(string filename, Object obj, bool append) {
