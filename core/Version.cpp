...
public: 
  ...
  /** the version file */
  // final static string VERSION_FILE = "weka/core/version.txt";
  ...
  static string VERSION = MAJOR + "." + MINOR + "." + REVISION;
   ...
   */
private:
  static void parseVersion(string version, int[] maj, int[] min, int[] rev) {
    int major = 0;
    int minor = 0;
    int revision = 0;
