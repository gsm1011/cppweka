 ...
 */
class StringLocator : public AttributeLocator {
public:
  /** for serialization */
   ...
   */
  static void copyStringValues(Instance inst, Instances destDataset, 
   ...
   */
  static void copyStringValues(Instance instance, bool instSrcCompat,
