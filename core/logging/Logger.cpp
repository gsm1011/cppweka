 ...
 */
class Logger : public RevisionHandler {
public: 
  /** the properties file. */
  const static string PROPERTIES_FILE = "weka/core/logging/Logging.props";
...
protected:
  ...
  static SimpleDateFormat m_DateFormat;
  ...
  static {
    try {
      ...
      cerr << "Error reading the logging properties '" <<
	PROPERTIES_FILE << "': " << e << endl;
...
protected: 
   ...
   */
  virtual void doLog(Level level, string msg, string cls, string method, int lineno);
...
public: 
   ...
   */
  static void log(Level level, Throwable t) {
