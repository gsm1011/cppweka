 ...
 */
#ifndef _CPP_WEKA_CHEBYSHEVDISTANCE_H_
#define _CPP_WEKA_CHEBYSHEVDISTANCE_H_
 ...
 */
class ChebyshevDistance : public NormalizableDistance,
...
public:
   ...
   */
  inline ChebyshevDistance(Instances data) {
    super(data);
  }
   ...
   */
protected:
  inline double updateDistance(double currDist, double diff) {
    double	result;
