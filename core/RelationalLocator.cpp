 ...
 */
class RelationalLocator : public AttributeLocator {
...
public:
   ...
   */
  static void copyRelationalValues(Instance inst, Instances destDataset, 
                               AttributeLocator strAtts) {

    if (inst.dataset() == NULL) {
      throw IllegalArgumentException("Instance has no dataset assigned!!");
   ...
   */
  static void copyRelationalValues(Instance instance, bool instSrcCompat,
