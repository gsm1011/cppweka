 ...
 */
class LinearNNSearch : public NearestNeighbourSearch {
...
public: 
   ...
   */
  void setSkipIdentical(bool skip) {
   ...
   */
  Instances kNearestNeighbours(Instance target, int kNN) throws Exception {
