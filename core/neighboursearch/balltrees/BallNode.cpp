 ...
 */
class BallNode : public Serializable, public RevisionHandler {
...
public:
  ...
  BallNode m_Left = null;
  
  /** The right child of the node. */
  BallNode m_Right = null;
...
public:   
   ...
   * indext array. 
   */
  void setStartEndIndices(int start, int end) {
    m_Start = start;
    m_End = end;
    m_NumInstances = end - start + 1;    
  }
   ...
   */
  static Instance calcCentroidPivot(int[] instList, Instances insts) {
   ...
   * @return The calculated centre/pivot of the node.  
   */
  static Instance calcCentroidPivot(int start, int end, int[] instList, 
                                          Instances insts) {
    double[] attrVals = new double[insts.numAttributes()];
    Instance temp;
   ...
   * radius. 
   */
  static double calcRadius(int[] instList, Instances insts,Instance pivot, 
   ...
   * radius. 
   */
  static double calcRadius(int start, int end, int[] instList, 
   ...
   * the pivot.
   */
  static Instance calcPivot(BallNode child1, BallNode child2, 
   ...
   */
  static double calcRadius(BallNode child1, BallNode child2, 
                                  Instance pivot, 
                                  DistanceFunction distanceFunction) 
                                                             throws Exception {
    Instance p1 = child1.getPivot(), p2 = child2.getPivot();                                                               
