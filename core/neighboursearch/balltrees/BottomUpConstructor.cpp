 ...
 */
class BottomUpConstructor : public BallTreeConstructor, public TechnicalInformationHandler {
...
protected:
   ...
   * merging the nodes. 
   */
  BallNode mergeNodes(FastVector list, int startIdx, int endIdx, 
   ...
   * @throws Exception If there is some problem.
   */
  BallNode makeBallTree(TempNode node, int startidx, int endidx, 
...
public:
   ...
   */
  double calcRadius(TempNode n1, TempNode n2) throws Exception {
   ...
   * @version $Revision: 1.3 $
   */
protected: class TempNode : public RevisionHandler {
  public: 
    /** The centre/pivot of the node. */
    Instance anchor;
