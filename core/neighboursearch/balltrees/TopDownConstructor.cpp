 ...
 */
class TopDownConstructor : public BallTreeConstructor, 
   ...
   */
protected:
  BallSplitter m_Splitter = new PointsClosestToFurthestChildren();
...
public:
   ...
   */
protected:
  void processNodesAfterAddInstance(BallNode node) {
   ...
   * splitting.
   */
  void splitNodes(BallNode node, int depth, final double rootRadius) throws Exception {
...
public:
   ...
   */
  void setBallSplitter(BallSplitter splitter) {
    m_Splitter = splitter;
  }
