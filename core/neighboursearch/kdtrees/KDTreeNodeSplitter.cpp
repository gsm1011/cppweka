 ...
 */
class KDTreeNodeSplitter : public Serializable, 
...
public:
   ...
   * given node.
   */
  virtual void splitNode(KDTreeNode node, int numNodesCreated, 
   ...
   */
  void setNodeWidthNormalization(bool normalize) {
...
protected:
   ...
   * initialized.
   */
  void correctlyInitialized() throws Exception {
    if(m_Instances==null)
