 ...
 */
class KMeansInpiredMethod : public KDTreeNodeSplitter, 
...
public:
   ...
   * given node.
   */
  void splitNode(KDTreeNode node, int numNodesCreated,
...
protected:
   ...
   */
  static int partition(Instances insts, int[] index, int attidx, int l, int r) {
   ...
   */
  static void quickSort(Instances insts, int[] indices, int attidx, int left, int right) {
   ...
   */
  int rearrangePoints(int[] indices, final int startidx, final int endidx,
