 ...
 */
class BallTree : public NearestNeighbourSearch, public TechnicalInformationHandler {
...
protected: 
  ...
  BallTreeConstructor m_TreeConstructor = new TopDownConstructor();
...
public: 
 ...
 /** 
   ...
   */
  string ballTreeConstructorTipText() {
